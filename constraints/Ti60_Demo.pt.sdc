...
set_clock_groups -group {clk_sys tdqss_clk core_clk tac_clk twd_clk}



set_max_delay -from [get_clocks {core_clk}] -to [get_clocks {clk_sys}] 5
set_false_path -from [get_clocks {tac_clk}] -to [get_clocks {clk_sys}] 
set_false_path -from [get_clocks {twd_clk}] -to [get_clocks {clk_sys}] 

set_max_delay -from [get_clocks {clk_sys}] -to [get_clocks {core_clk}] 5
...
set_false_path -from [get_clocks clk_sys] -to [get_clocks clk_pixel_2x]
...
set_false_path -from [get_clocks {clk_sys}] -to [get_clocks {clk_lvds_1x}] 


set_false_path -from [get_clocks {clk_lvds_1x}] -to [get_clocks {clk_sys}] 
...
set_false_path -from [get_clocks clk_pixel_2x] -to [get_clocks clk_sys]
...
# LVDS Tx Constraints
#######################
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -max 0.878 [get_ports {hdmi_txc_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -min 0.360 [get_ports {hdmi_txc_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -max 0.878 [get_ports {hdmi_txc_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -min 0.360 [get_ports {hdmi_txc_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -max 0.878 [get_ports {hdmi_txd0_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -min 0.360 [get_ports {hdmi_txd0_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -max 0.878 [get_ports {hdmi_txd0_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -min 0.360 [get_ports {hdmi_txd0_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -max 0.878 [get_ports {hdmi_txd1_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -min 0.360 [get_ports {hdmi_txd1_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -max 0.878 [get_ports {hdmi_txd1_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -min 0.360 [get_ports {hdmi_txd1_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -max 0.878 [get_ports {hdmi_txd2_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -min 0.360 [get_ports {hdmi_txd2_o[*]}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -max 0.878 [get_ports {hdmi_txd2_oe}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -min 0.360 [get_ports {hdmi_txd2_oe}]
...
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -max 0.920 [get_ports {hdmi_txc_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}] -min 0.335 [get_ports {hdmi_txc_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -max 0.920 [get_ports {hdmi_txd0_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}] -min 0.335 [get_ports {hdmi_txd0_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -max 0.920 [get_ports {hdmi_txd1_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}] -min 0.335 [get_ports {hdmi_txd1_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -max 0.920 [get_ports {hdmi_txd2_rst_o}]
set_output_delay -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}] -min 0.335 [get_ports {hdmi_txd2_rst_o}]
...
set_output_delay -clock csi_rxc_i -max 0.815 [get_ports {csi_rxd0_rst_o}]
set_output_delay -clock csi_rxc_i -min 0.360 [get_ports {csi_rxd0_rst_o}]
set_input_delay -clock csi_rxc_i -max 1.012 [get_ports {csi_rxd0_hs_i[*]}]
set_input_delay -clock csi_rxc_i -min 0.842 [get_ports {csi_rxd0_hs_i[*]}]
set_output_delay -clock csi_rxc_i -max 0.815 [get_ports {csi_rxd1_rst_o}]
set_output_delay -clock csi_rxc_i -min 0.360 [get_ports {csi_rxd1_rst_o}]
set_input_delay -clock csi_rxc_i -max 1.012 [get_ports {csi_rxd1_hs_i[*]}]
set_input_delay -clock csi_rxc_i -min 0.842 [get_ports {csi_rxd1_hs_i[*]}]
set_output_delay -clock csi_rxc_i -max 0.815 [get_ports {csi_rxd2_rst_o}]
set_output_delay -clock csi_rxc_i -min 0.360 [get_ports {csi_rxd2_rst_o}]
set_input_delay -clock csi_rxc_i -max 1.012 [get_ports {csi_rxd2_hs_i[*]}]
set_input_delay -clock csi_rxc_i -min 0.842 [get_ports {csi_rxd2_hs_i[*]}]
set_output_delay -clock csi_rxc_i -max 0.815 [get_ports {csi_rxd3_rst_o}]
set_output_delay -clock csi_rxc_i -min 0.360 [get_ports {csi_rxd3_rst_o}]
set_input_delay -clock csi_rxc_i -max 1.012 [get_ports {csi_rxd3_hs_i[*]}]
set_input_delay -clock csi_rxc_i -min 0.842 [get_ports {csi_rxd3_hs_i[*]}]

# MIPI TX Lane Constraints
############################
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~200}] -max 0.878 [get_ports {dsi_txc_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~200}] -min 0.360 [get_ports {dsi_txc_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~200}] -max 0.815 [get_ports {dsi_txc_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~200}] -min 0.360 [get_ports {dsi_txc_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~187}] -max 0.878 [get_ports {dsi_txd0_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~187}] -min 0.360 [get_ports {dsi_txd0_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~187}] -max 0.815 [get_ports {dsi_txd0_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~187}] -min 0.360 [get_ports {dsi_txd0_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~215}] -max 0.878 [get_ports {dsi_txd1_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~215}] -min 0.360 [get_ports {dsi_txd1_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~215}] -max 0.815 [get_ports {dsi_txd1_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~215}] -min 0.360 [get_ports {dsi_txd1_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~230}] -max 0.878 [get_ports {dsi_txd2_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~230}] -min 0.360 [get_ports {dsi_txd2_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~230}] -max 0.815 [get_ports {dsi_txd2_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~230}] -min 0.360 [get_ports {dsi_txd2_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~175}] -max 0.878 [get_ports {dsi_txd3_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~175}] -min 0.360 [get_ports {dsi_txd3_hs_o[*]}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~175}] -max 0.815 [get_ports {dsi_txd3_rst_o}]
set_output_delay -clock dsi_byteclk_i -reference_pin [get_ports {dsi_byteclk_i~CLKOUT~218~175}] -min 0.360 [get_ports {dsi_txd3_rst_o}]
...
# hdmi_txc -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~63~322}]
# hdmi_txd0 -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~195~322}]
# hdmi_txd1 -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~31~322}]
# hdmi_txd2 -clock clk_pixel_2x -reference_pin [get_ports {clk_pixel_2x~CLKOUT~55~322}]
